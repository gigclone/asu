...
wget -q -O /etc/nginx/nginx.conf "https://raw.githubusercontent.com/gigclone/asu/main/mode/nginx.conf.txt" 
mkdir -p /home/vps/public_html
wget -q -O /etc/nginx/conf.d/vps.conf "https://raw.githubusercontent.com/gigclone/asu/main/mode/vps.conf.txt"

wget -q -O xraymode.sh https://raw.githubusercontent.com/gigclone/asu/main/mode/xraymode.sh && chmod +x xraymode.sh && ./xraymode.sh
sleep 1 
wget -q -O xray.conf https://raw.githubusercontent.com/gigclone/asu/main/mode/xray.conf.txt && chmod +x xray.conf && ./xray.conf
sleep 1 
