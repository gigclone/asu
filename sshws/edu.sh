...
wget -q -O /usr/local/bin/ws-nontls https://raw.githubusercontent.com/gigclone/asu/main/sshws/websocket.py
...
# Getting Proxy Template
wget -q -O /usr/local/bin/ws-ovpn https://raw.githubusercontent.com/gigclone/asu/main/sshws/ws-ovpn.py
...
# Getting Proxy Template
wget -q -O /usr/local/bin/ws-tls https://raw.githubusercontent.com/gigclone/asu/main/sshws/ws-tls
