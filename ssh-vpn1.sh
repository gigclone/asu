...
wget -O /etc/squid/squid.conf "https://raw.githubusercontent.com/gigclone/asu/main/squid3.conf"
...
wget https://raw.githubusercontent.com/gigclone/asu/main/ssh/bbr.sh && chmod +x bbr.sh && ./bbr.sh
